...
if ((vest TFAR_currentUnit) == "V_RebreatherB" ||
    (vest TFAR_currentUnit) == "1MEU_BASE_M52A_Armor" ||
    (vest TFAR_currentUnit) == "1MEU_BASE_M52D_Armor" ||
    (vest TFAR_currentUnit) == "1MEU_BASE_Pilot_Armor") exitWith {true};
