#define COMPONENT MEU_compat
#define COMPONENT_BEAUTIFIED Operation Trebuchet Ace Compatibility
...
#ifdef DEBUG_ENABLED_MEU_compat
    #define DEBUG_MODE_FULL
#endif

#ifdef DEBUG_SETTINGS_MEU_compat
    #define DEBUG_SETTINGS DEBUG_SETTINGS_MEU_compat
#endif
